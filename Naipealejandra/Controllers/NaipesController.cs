...
namespace Naipealejandra.Controllers
{
    ...
    public class NaipesController : ControllerBase
    {
        ...
        public async Task<ActionResult<Naipe>> PostNaipe(Naipe naipe)
        {
            ...
            return CreatedAtAction("GetNaipe", new { id = naipe.IdNaipe }, naipe);
        }
        ...
        {
            return _context.Naipe.Any(e => e.IdNaipe == id);
        }
    }
}
